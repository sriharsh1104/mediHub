...
const Dashboard: React.FC = () => {
  ...
  const organizationId = useSelector((state: any) => state.userDataSlice?.companyId);
      ...
      <form onSubmit={handleRegister}>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="bg-white p-4 rounded-md shadow-md">
            <label htmlFor="companyId" className="block text-xl font-semibold mb-2">
              Company ID
            </label>
            <input
              type="text"
        ...
        <button onClick={handleRegister} type="submit" className="mt-4 bg-blue-500 text-white p-2 rounded-md">
          Add Member
        </button>
      </form>
    </div>
